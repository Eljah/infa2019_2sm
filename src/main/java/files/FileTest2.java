...
//            printWriter.close();
//        } catch (IOException e) {
//            e.printStackTrace(); //TODO undestand that it is wrong try catch use, just example
//        }
////
//        try {
...
//
        try {
            ...
            outStream.writeLong(new Date().getTime());
            outStream.close();
            ...
            result = reader.readUTF();
            System.out.println(result);
            Date readDate=new Date(reader.readLong());
